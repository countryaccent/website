...
function createMap(){
    ...
    var point = new BMap.Point(115.9682786014,28.6844705374);//定义一个中心点坐标
...
//标注点数组
var markerArr = [{title:"公司位置",content:"公司位置",point:"115.9682786014|28.6844705374",isOpen:1,icon:{w:21,h:25,l:0,t:0,x:6,lb:5}}
	 ];
//创建marker
function addMarker(){
